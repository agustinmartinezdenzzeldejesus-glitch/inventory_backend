	...
	public ResponseEntity<CategoryResponseRest> searchById(Long id) {
		...
		try{
			...
			if(category.isPresent()) {
				...
				response.setMetadata("Respuesta NO ok", "-1", "Error al CATEGORIA no encontrada");
	...
	public ResponseEntity<CategoryResponseRest> save(Category category) {
		...
		try{
			...
			if(categorySaved !=null) {
				...
				response.setMetadata("Respuesta NO ok", "-1", "Categpria no guardada");
		...
		try{
			...
			if(categorySearch.isPresent()){
				...
				if(categoryToUpdate !=null){
					...
					response.setMetadata("Respuesta NO ok", "-1", "Categpria no actualizada");
					return new ResponseEntity<CategoryResponseRest>(response,HttpStatus.BAD_REQUEST);
				}
			}else {
				response.setMetadata("Respuesta NO ok", "-1", "Categpria no encontrada");
				return new ResponseEntity<CategoryResponseRest>(response,HttpStatus.NOT_FOUND);
			}
	}catch (Exception e) {
